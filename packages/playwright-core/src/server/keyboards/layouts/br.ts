...
const keyboardLayout: KeyboardLayout = {
  ...
  Digit6: { key: '6', keyCode: 54, shiftKey: '¨', ctrlAltKey: '¬', shiftDeadKeyMappings: { 'a': 'ä', 'e': 'ë', 'i': 'ï', 'o': 'ö', 'u': 'ü', 'y': 'ÿ', 'A': 'Ä', 'E': 'Ë', 'I': 'Ï', 'O': 'Ö', 'U': 'Ü', ' ': '¨' } },
  ...
  KeyW: { key: 'w', keyCode: 87, shiftKey: 'W', ctrlAltKey: '?' },
  ...
  BracketRight: { key: '[', keyCode: 221, shiftKey: '{', ctrlAltKey: 'ª' },
  ...
  Backslash: { key: ']', keyCode: 220, shiftKey: '}', ctrlAltKey: 'º' },
  ...
  KeyC: { key: 'c', keyCode: 67, shiftKey: 'C', ctrlAltKey: '₢' },
