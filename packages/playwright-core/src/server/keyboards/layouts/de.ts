...
const keyboardLayout: KeyboardLayout = {
  ...
  Backquote: { key: '^', keyCode: 220, shiftKey: '°', deadKeyMappings: { 'a': 'â', 'e': 'ê', 'i': 'î', 'o': 'ô', 'u': 'û', 'A': 'Â', 'E': 'Ê', 'I': 'Î', 'O': 'Ô', 'U': 'Û', ' ': '^' } },
  ...
  Digit9: { key: '9', keyCode: 57, shiftKey: ')', ctrlAltKey: ']' },
  Digit0: { key: '0', keyCode: 48, shiftKey: '=', ctrlAltKey: '}' },
  Minus: { key: 'ß', keyCode: 219, shiftKey: '?', ctrlAltKey: '\\' },
  Equal: { key: '´', keyCode: 221, shiftKey: '`', deadKeyMappings: { 'a': 'á', 'e': 'é', 'i': 'í', 'o': 'ó', 'u': 'ú', 'y': 'ý', 'A': 'Á', 'E': 'É', 'I': 'Í', 'O': 'Ó', 'U': 'Ú', 'Y': 'Ý', ' ': '´' }, shiftDeadKeyMappings: { 'a': 'à', 'e': 'è', 'i': 'ì', 'o': 'ò', 'u': 'ù', 'A': 'À', 'E': 'È', 'I': 'Ì', 'O': 'Ò', 'U': 'Ù', ' ': '`' } },
  Backspace: { key: 'Backspace', keyCode: 8 },
  Tab: { key: 'Tab', keyCode: 9 },
  KeyQ: { key: 'q', keyCode: 81, shiftKey: 'Q', ctrlAltKey: '@' },
  ...
  BracketLeft: { key: 'ü', keyCode: 186, shiftKey: 'Ü' },
  BracketRight: { key: '+', keyCode: 187, shiftKey: '*', ctrlAltKey: '~' },
  ...
  Semicolon: { key: 'ö', keyCode: 192, shiftKey: 'Ö' },
  Quote: { key: 'ä', keyCode: 222, shiftKey: 'Ä' },
  ...
  KeyM: { key: 'm', keyCode: 77, shiftKey: 'M', ctrlAltKey: 'µ' },
