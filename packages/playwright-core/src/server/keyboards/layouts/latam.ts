...
// KLID 0000080A - Spanish (Latin America)
const keyboardLayout: KeyboardLayout = {
  ...
  Backquote: { key: '|', keyCode: 220, shiftKey: '°', ctrlAltKey: '¬' },
  ...
  Quote: { key: '{', keyCode: 222, shiftKey: '[', ctrlAltKey: '^', ctrlAltDeadKeyMappings: { 'a': 'â', 'e': 'ê', 'i': 'î', 'o': 'ô', 'u': 'û', 'A': 'Â', 'E': 'Ê', 'I': 'Î', 'O': 'Ô', 'U': 'Û', ' ': '^' } },
  Backslash: { key: '}', keyCode: 191, shiftKey: ']', ctrlAltKey: '`', ctrlAltDeadKeyMappings: { 'a': 'à', 'e': 'è', 'i': 'ì', 'o': 'ò', 'u': 'ù', 'A': 'À', 'E': 'È', 'I': 'Ì', 'O': 'Ò', 'U': 'Ù', ' ': '`' } },
