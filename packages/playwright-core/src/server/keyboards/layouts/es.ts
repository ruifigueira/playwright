...
const keyboardLayout: KeyboardLayout = {
  ...
  Backquote: { key: 'º', keyCode: 220, shiftKey: 'ª', ctrlAltKey: '\\' },
  ...
  Digit4: { key: '4', keyCode: 52, shiftKey: '$', ctrlAltKey: '~', ctrlAltDeadKeyMappings: { 'a': 'ã', 'n': 'ñ', 'o': 'õ', 'A': 'Ã', 'N': 'Ñ', 'O': 'Õ', ' ': '~' } },
  ...
  BracketLeft: { key: '`', keyCode: 186, shiftKey: '^', ctrlAltKey: '[', deadKeyMappings: { 'a': 'à', 'e': 'è', 'i': 'ì', 'o': 'ò', 'u': 'ù', 'A': 'À', 'E': 'È', 'I': 'Ì', 'O': 'Ò', 'U': 'Ù', ' ': '`' }, shiftDeadKeyMappings: { 'a': 'â', 'e': 'ê', 'i': 'î', 'o': 'ô', 'u': 'û', 'A': 'Â', 'E': 'Ê', 'I': 'Î', 'O': 'Ô', 'U': 'Û', ' ': '^' } },
  ...
  Quote: { key: '´', keyCode: 222, shiftKey: '¨', ctrlAltKey: '{', deadKeyMappings: { 'a': 'á', 'e': 'é', 'i': 'í', 'o': 'ó', 'u': 'ú', 'y': 'ý', 'A': 'Á', 'E': 'É', 'I': 'Í', 'O': 'Ó', 'U': 'Ú', 'Y': 'Ý', ' ': '´' }, shiftDeadKeyMappings: { 'a': 'ä', 'e': 'ë', 'i': 'ï', 'o': 'ö', 'u': 'ü', 'y': 'ÿ', 'A': 'Ä', 'E': 'Ë', 'I': 'Ï', 'O': 'Ö', 'U': 'Ü', ' ': '¨' } },
  Backslash: { key: 'ç', keyCode: 191, shiftKey: 'Ç', ctrlAltKey: '}' },
