...
// KLID 00000807 - German (Switzerland)
const keyboardLayout: KeyboardLayout = {
  ...
  BracketLeft: { key: 'ü', keyCode: 186, shiftKey: 'è', ctrlAltKey: '[' },
  ...
  Semicolon: { key: 'ö', keyCode: 222, shiftKey: 'é' },
  Quote: { key: 'ä', keyCode: 220, shiftKey: 'à', ctrlAltKey: '{' },
