...
// KLID 0000100C - French and Italian (Switzerland)
const keyboardLayout: KeyboardLayout = {
  ...
  Backquote: { key: '§', keyCode: 191, shiftKey: '°' },
  Digit1: { key: '1', keyCode: 49, shiftKey: '+', ctrlAltKey: '¦' },
  Digit2: { key: '2', keyCode: 50, shiftKey: '"', ctrlAltKey: '@' },
  Digit3: { key: '3', keyCode: 51, shiftKey: '*', ctrlAltKey: '#' },
  Digit4: { key: '4', keyCode: 52, shiftKey: 'ç', ctrlAltKey: '°' },
  Digit5: { key: '5', keyCode: 53, shiftKey: '%', ctrlAltKey: '§' },
  Digit6: { key: '6', keyCode: 54, shiftKey: '&', ctrlAltKey: '¬' },
  Digit7: { key: '7', keyCode: 55, shiftKey: '/', ctrlAltKey: '|' },
  Digit8: { key: '8', keyCode: 56, shiftKey: '(', ctrlAltKey: '¢' },
  Digit9: { key: '9', keyCode: 57, shiftKey: ')' },
  Digit0: { key: '0', keyCode: 48, shiftKey: '=' },
  Minus: { key: '\'', keyCode: 219, shiftKey: '?', ctrlAltKey: '´', ctrlAltDeadKeyMappings: { 'a': 'á', 'e': 'é', 'i': 'í', 'o': 'ó', 'u': 'ú', 'y': 'ý', 'A': 'Á', 'E': 'É', 'I': 'Í', 'O': 'Ó', 'U': 'Ú', 'Y': 'Ý', ' ': '´' } },
  Equal: { key: '^', keyCode: 221, shiftKey: '`', ctrlAltKey: '~', deadKeyMappings: { 'a': 'â', 'e': 'ê', 'i': 'î', 'o': 'ô', 'u': 'û', 'A': 'Â', 'E': 'Ê', 'I': 'Î', 'O': 'Ô', 'U': 'Û', ' ': '^' }, shiftDeadKeyMappings: { 'a': 'à', 'e': 'è', 'i': 'ì', 'o': 'ò', 'u': 'ù', 'A': 'À', 'E': 'È', 'I': 'Ì', 'O': 'Ò', 'U': 'Ù', ' ': '`' }, ctrlAltDeadKeyMappings: { 'a': 'ã', 'o': 'õ', 'n': 'ñ', 'A': 'Ã', 'O': 'Õ', 'N': 'Ñ', ' ': '~' } },
  Backspace: { key: 'Backspace', keyCode: 8 },
  Tab: { key: 'Tab', keyCode: 9 },
  KeyQ: { key: 'q', keyCode: 81, shiftKey: 'Q' },
  KeyW: { key: 'w', keyCode: 87, shiftKey: 'W' },
  KeyE: { key: 'e', keyCode: 69, shiftKey: 'E', ctrlAltKey: '€' },
  KeyR: { key: 'r', keyCode: 82, shiftKey: 'R' },
  KeyT: { key: 't', keyCode: 84, shiftKey: 'T' },
  KeyY: { key: 'z', keyCode: 90, shiftKey: 'Z' },
  ...
  BracketLeft: { key: 'è', keyCode: 186, shiftKey: 'ü', ctrlAltKey: '[' },
  BracketRight: { key: '¨', keyCode: 192, shiftKey: '!', ctrlAltKey: ']', deadKeyMappings: { 'a': 'ä', 'e': 'ë', 'i': 'ï', 'o': 'ö', 'u': 'ü', 'y': 'ÿ', 'A': 'Ä', 'E': 'Ë', 'I': 'Ï', 'O': 'Ö', 'U': 'Ü', ' ': '"' } },
  ...
  Semicolon: { key: 'é', keyCode: 222, shiftKey: 'ö' },
  Quote: { key: 'à', keyCode: 220, shiftKey: 'ä', ctrlAltKey: '{' },
  Backslash: { key: '$', keyCode: 223, shiftKey: '£', ctrlAltKey: '}' },
  ShiftLeft: { key: 'Shift', keyCode: 160, keyCodeWithoutLocation: 16, location: 1 },
  IntlBackslash: { key: '<', keyCode: 226, shiftKey: '>', ctrlAltKey: '\\' },
  KeyZ: { key: 'y', keyCode: 89, shiftKey: 'Y' },
