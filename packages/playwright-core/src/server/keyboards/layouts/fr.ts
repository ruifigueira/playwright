...
const keyboardLayout: KeyboardLayout = {
  ...
  Digit2: { key: 'é', keyCode: 50, shiftKey: '2', ctrlAltKey: '~', ctrlAltDeadKeyMappings: { 'a': 'ã', 'A': 'Ã', 'n': 'ñ', 'N': 'Ñ', 'o': 'õ', 'O': 'Õ', ' ': '~' } },
  Digit3: { key: '"', keyCode: 51, shiftKey: '3', ctrlAltKey: '#' },
  Digit4: { key: '\'', keyCode: 52, shiftKey: '4', ctrlAltKey: '{' },
  Digit5: { key: '(', keyCode: 53, shiftKey: '5', ctrlAltKey: '[' },
  Digit6: { key: '-', keyCode: 54, shiftKey: '6', ctrlAltKey: '|' },
  Digit7: { key: 'è', keyCode: 55, shiftKey: '7', ctrlAltKey: '`', ctrlAltDeadKeyMappings: { 'a': 'à', 'e': 'è', 'i': 'ì', 'o': 'ò', 'u': 'ù', 'A': 'À', 'E': 'È', 'I': 'Ì', 'O': 'Ò', 'U': 'Ù', ' ': '`' } },
  Digit8: { key: '_', keyCode: 56, shiftKey: '8', ctrlAltKey: '\\' },
  Digit9: { key: 'ç', keyCode: 57, shiftKey: '9', ctrlAltKey: '^' },
  Digit0: { key: 'à', keyCode: 48, shiftKey: '0', ctrlAltKey: '@' },
  Minus: { key: ')', keyCode: 219, shiftKey: '°', ctrlAltKey: ']' },
  Equal: { key: '=', keyCode: 187, shiftKey: '+', ctrlAltKey: '}' },
  ...
  BracketRight: { key: '$', keyCode: 186, shiftKey: '£', ctrlAltKey: '¤' },
